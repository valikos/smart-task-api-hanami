...
module OAuth
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['OAUTH_SESSIONS_SECRET']
      ...
      #
      # layout :application # It will load Oauth::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Oauth::Action is included
      ...
      # Configure the code that will yield each time Oauth::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      # view.prepare do
      #   include Hanami::Helpers
      #   include Oauth::Assets::Helpers
      # end
    end
